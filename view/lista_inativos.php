...
$torcedores = buscaTorcedoresInativos($conn);

?>
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i> Lista de Torcedores Inativos</h1>
    ...
    <?php
    if(isset($_GET['mensagem'])  && $_GET['mensagem'] == 'ativo'){
    ?>
    <p class="alert alert-success">O usuário foi ativado</p>
    <?php
    }
    ?>
    <div class="row">
                        ...
                        <tbody>
                           <?php foreach ($torcedores as $torcedor): ?>
                            <tr>
                                ...
                                <td><a href="../controller/logica.php?id=<?= $torcedor['torcedor_id'] ?>&acao=ativar" class="btn btn-primary btn-sm">Ativar</a></td>                               
                            </tr>
                            <?php endforeach; ?>                            
                        </tbody>
                    </table>
